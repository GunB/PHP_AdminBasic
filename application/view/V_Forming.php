...
// viene de la funcion crea_form del controlador m_data
//var_dump($form);
...
function showForm($form){
    ...
    <div class="container">
        <form method="post">
            <?php
            //$data['form'] = $info_json;
            //$data['table_striped'] = false;
            //$this->load->view('base/formulario', $data);
            decodeForm($form);
            ?>
            <!--<button class="btn btn-success btn-large">Enviar información</button>-->
        </form>
    </div>
    <?php
}
